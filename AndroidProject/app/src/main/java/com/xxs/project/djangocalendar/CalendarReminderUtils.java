...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_ACCOUNT_NAME = "test@testmail.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.test";
    private static String CALENDARS_DISPLAY_NAME = "Test's Account";
    ...
    public static void addCalendarEvent(Context context, String title, String description, long reminderTime, long dueTime, int previousDate) {
        if (context == null) {
            return;
        }
        ...
        mCalendar.setTimeInMillis(dueTime);
        ...
        event.put(CalendarContract.Events.EVENT_TIMEZONE, TimeZone.getDefault().getDisplayName());
